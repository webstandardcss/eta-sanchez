...
<!-- Notable Header Starts -->
	...
	<h1>Jose Sanchez Settles Truck Death Case for $350,000</h1>
	<p>Jose Sanchez and Brent Goudarzi settled a death case in which the deceased was test driving a truck and the tread on the tires were not up to code. Due to this, it caused the truck to go off road and hit another car. </p>
...
<!-- Notable Results Starts -->
	...
	<!-- Each Column Starts -->				
		<div class="each-result">			
			<p>Rocio M. Ramos recives work permit and residency.</p>			
			<a href="testimony-rocio-ramos.php">+ More</a>		
		</div>
